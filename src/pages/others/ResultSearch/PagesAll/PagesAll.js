...
function PagesAll() {
    ...
    return (
        <div className={cx('page-search')}>
            ...
            {/* ---------------------- */}
            {data?.songs && (
                <Container className={cx('songs')} title={data?.songs.link} all link={`/tim-kiem/bai-hat/${value}`}>
            ...
            {/* ---------------------- */}
            {data?.videos && (
                <Container className={cx('mv')} title={data?.videos.title} all link={`/tim-kiem/video/${value}`}>
